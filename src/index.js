...
class PhoneInput extends React.Component {
  ...
  componentDidMount() {
    ...
    this.popupContainerElement.id = "react-phone-input-fixed-popup-container";
  ...
  handleClickOutside = (e) => {
    if (
      this.dropdownRef &&
      !this.dropdownContainerRef.contains(e.target) &&
  ...
  getCountryDropdownList = () => {
    ...
    const { disableDropdown, prefix, fixedPopup } = this.props;
